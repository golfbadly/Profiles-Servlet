	...
	public void doGet(HttpServletRequest request,
	 HttpServletResponse response)
		...
		Statement st = conn.createStatement();
			...
			request.setAttribute("about", a);
                        request.setAttribute("location", l);
                        request.setAttribute("contact", c);
                        request.setAttribute("education", e);
                        
			request.getRequestDispatcher("p_aboutme.jsp").forward(request, response);
	         	request.getRequestDispatcher("p_where.jsp").forward(request, response);
                        request.getRequestDispatcher("p_contact.jsp").forward(request, response);
